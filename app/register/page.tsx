    ...
    <Box
      sx={{
        ...
        '&::after': {
          ...
          width: '50%',
          height: '50%',
          background: 'radial-gradient(circle, rgba(212, 255, 0, 0.25) 0%, transparent 70%)',
          borderRadius: '50%',
      ...
      <Container maxWidth="sm">
        <Box sx={{ textAlign: 'center', mb: { xs: 3, sm: 4, md: 5 }, position: 'relative', zIndex: 1 }}>
          ...
          <Typography variant="body1" sx={{ color: 'rgba(255,255,255,0.8)', fontSize: { xs: '0.85rem', sm: '0.95rem', md: '1rem' } }}>
            สร้างบัญชีและเริ่มสร้างการ์ดวันเกิดสุดพิเศษ
          </Typography>
        </Box>
          ...
          <Box component="form" onSubmit={handleSubmit(onSubmit)}>
            ...
            <Button
              ...
              sx={{
                ...
                borderRadius: 2,
                boxShadow: '0 8px 24px rgba(212, 255, 0, 0.5)',
                '&:hover': {
                  background: 'linear-gradient(135deg, #FFC107 0%, #FFB300 100%)',
                  boxShadow: '0 12px 32px rgba(168, 229, 0, 0.6)',
